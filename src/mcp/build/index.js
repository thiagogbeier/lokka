...
async function makeAdvancedGraphRequest(path, method = 'GET', version = 'beta', queryParams = {}, body, allData = false) {
    ...
    try {
        ...
        const finalResult = {
            ...
            ...Object.fromEntries(Object.entries(responseData).filter(([key]) => key !== '@odata.nextLink' && key !== 'value')),
...
server.tool("graph-query", `Execute flexible Microsoft Graph API queries with support for multiple HTTP methods, API versions, and pagination 
  `, {
    ...
    try {
        ...
        const response = await makeAdvancedGraphRequest(path, method, version, queryParams || {}, body, allData);
