...
async function createEmptyWordDocument(zip) {
...
async function createEmptyExcelWorkbook(zip) {
...
async function createEmptyPowerPointPresentation(zip) {
...
async function createOfficeFileWithContent(fileType, templateContent) {
...
server.tool("create-office-file", "Create Microsoft Office files (Word, Excel, PowerPoint) in SharePoint Online or OneDrive for Business using Microsoft Graph API.", {
