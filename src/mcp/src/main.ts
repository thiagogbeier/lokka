...
async function createEmptyOfficeFile(fileType: "word" | "excel" | "powerpoint"): Promise<string> {
...
async function createOfficeFileFromTemplate(fileType: "word" | "excel" | "powerpoint"): Promise<any> {
...
server.tool(
  "create-office-file",
  "Create Microsoft Office files (Word, Excel, PowerPoint) using a working method - upload a real template file via Graph API.",
  {
