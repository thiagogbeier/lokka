...
server.tool(
  "get-recent-groups",
  "Query groups created within a specified time period (default: past week). This is a convenience tool that uses Microsoft Graph's filter capabilities to find recently created groups.",
  {
